...
bot = commands.Bot(command_prefix=get_prefix, owner_id=config.discord.ownerID, intents=intents, sync_commands=True, sync_commands_debug=True, test_guilds=[int(each) for each in config.discord.guild_id.split(",")])
